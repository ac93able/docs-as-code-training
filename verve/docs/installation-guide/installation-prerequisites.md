...
| Requirement | Why it is needed | Check before you start |
| --- | --- | --- |
| Administrator access | Allows the installation wizard to make system changes. | Confirm that you can approve software installation. |
| Internet access | Supports installation and the first sign-in. | Confirm that the device can reach your organization's network. |
