...
## Contents
- [Verve Release Notes](#verve-release-notes)
...
The Verve documentation in this release is available in English only. Additional language versions are not currently provided.

## Acknowledgements

No third-party technologies are listed in the available Verve documentation. Add approved third-party notices when the Verve dependency inventory is available.
